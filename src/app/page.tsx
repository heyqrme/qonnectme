    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative diagonal-lines">
      ...
      <main className="container mx-auto px-4 py-16 relative z-10">
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-8rem)]">
          ...
          >
            <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 p-6 rounded-xl relative overflow-hidden group backdrop-blur-nightlife hover:scale-[1.03] transition-transform duration-300">
              ...
              />
              <h3 className="text-xl font-bold mb-3 neon-text-purple">Get Your Identity</h3>
              <p className="text-gray-400">Sign up and receive your unique QR code that represents you in the Qonnectme community.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 p-6 rounded-xl relative overflow-hidden group backdrop-blur-nightlife hover:scale-[1.03] transition-transform duration-300">
              ...
              />
              <h3 className="text-xl font-bold mb-3 neon-text-pink">Connect with Friends</h3>
              <p className="text-gray-400">Scan QR codes to instantly connect with other members and build your social network.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 p-6 rounded-xl relative overflow-hidden group backdrop-blur-nightlife hover:scale-[1.03] transition-transform duration-300">
              ...
              />
              <h3 className="text-xl font-bold mb-3 neon-text-blue">Wear Your Code</h3>
              <p className="text-gray-400">Shop exclusive products featuring your personal QR code and showcase your digital identity.</p>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 p-8 rounded-xl relative overflow-hidden backdrop-blur-nightlife">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  <h2 className="text-3xl font-bold mb-4 text-white neo-glow glow-text">Your Social Identity</h2>
                  <p className="text-gray-400 mb-6">
                    Your QR code is more than just a pattern – it's your digital identity in the nightlife and social scene. 
                ...
                <div className="flex justify-center">
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className={`bg-black p-4 rounded-lg relative transition-all duration-300 ${hoverQR ? 'scale-110 shadow-[0_0_30px_rgba(168,85,247,0.8)]' : 'shadow-[0_0_15px_rgba(168,85,247,0.4)]'}`}
